...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 */
	@Override
	public int loadBeanDefinitions(@NotNull Resource resource) throws BeanDefinitionStoreException {
		/**
		 * EncodedResource 是处理资源文件的编码的，其中主要逻辑体现在 getReader() 方法中，
		 * 我们可以在 EncodedResource 构造器中设置编码，Spring 就会使用相应的编码作为输入流的编码
		 */
	...
	public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
		...
		if (logger.isInfoEnabled()) logger.info("Loading XML bean definitions from " + encodedResource);
	...
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {
		...
		/**
		 * getRegistry() 其实就是 BeanFactory
		 * BeanFactory 初始化创建 XML Bean 定义解析器的时候就在构造器中指定
